...
![Protected by SpecLock](https://img.shields.io/badge/Protected_by-SpecLock-FF6B2C?style=flat&logo=lock)
...
![Protected by SpecLock](https://img.shields.io/badge/Protected_by-SpecLock-FF6B2C?style=flat-square&logo=lock)
...
![Protected by SpecLock](https://img.shields.io/badge/PROTECTED_BY-SPECLOCK-FF6B2C?style=for-the-badge&logo=lock&logoColor=white)
...
![SpecLock](https://img.shields.io/npm/v/speclock?label=SpecLock&color=FF6B2C&logo=lock)
...
![Tests](https://img.shields.io/badge/SpecLock_Tests-1043%20passing-success)

**Markdown**

```markdown
[![Tests](https://img.shields.io/badge/SpecLock_Tests-1043%20passing-success)](https://github.com/sgroy10/speclock)
```
...
![Downloads](https://img.shields.io/npm/dm/speclock?label=SpecLock%20downloads&color=FF6B2C)
